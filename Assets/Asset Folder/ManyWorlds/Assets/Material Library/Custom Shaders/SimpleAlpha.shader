...
/*SF_DATA;ver:0.34;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:True,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,blpr:1,bsrc:3,bdst:7,culm:0,dpts:2,wrdp:False,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.1141153,fgcg:0.08953287,fgcb:0.1764706,fgca:1,fgde:0.06,fgrn:0,fgrf:30,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32719,y:32712|diff-2-RGB,alpha-2-A;n:type:ShaderForge.SFN_Tex2d,id:2,x:33133,y:32638,ptlb:Diffuse,ptin:_Diffuse,ntxv:0,isnm:False;proporder:2;pass:END;sub:END;*/

Shader "ManyWorlds/Basic/SimpleAlpha" {
    Properties {
...
/////// Diffuse:
                ...
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_11.rg, _Diffuse));
...
/////// Diffuse:
                ...
                float4 node_2 = tex2D(_Diffuse,TRANSFORM_TEX(node_12.rg, _Diffuse));
                finalColor += diffuseLight * node_2.rgb;
/// Final Color:
